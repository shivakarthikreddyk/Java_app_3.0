        ...
        stage ('Pushing Jar file to Jfrog'){
          ...
          steps{
            script{
                ...
                sh "curl -X PUT -u admin:charan@Akash.98 -T /var/lib/jenkins/workspace/java-3.0/target/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar "${artifactory_url}/example-repo-local/${file_name}"""
            }
          }
        }
    }
