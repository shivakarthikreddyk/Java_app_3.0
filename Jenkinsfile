        ...
        stage ('Pushing Jar file to Jfrog'){
          ...
          steps{
            script{
                ...
                sh "curl -X PUT -u admin:charan@Akash.98 -T /var/lib/jenkins/workspace/java-3.0/target/ http://100.26.121.215:8082/artifactory/example-repo-local/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar"
                }
            }
        }
    }
